...
export enum TiltDevApiApiKeys {
}

export class TiltDevApi {
    ...
    public setApiKey(key: TiltDevApiApiKeys, value: string) {
        (this.authentications as any)[TiltDevApiApiKeys[key]].apiKey = value;
    }
    ...
    public async getAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1APIGroup;  }> {
        const localVarPath = this.basePath + '/apis/tilt.dev/';
