...
*/
export class V1alpha1ExtensionRepo {
    /**
    ...
    */
    ...
    'spec'?: V1alpha1ExtensionRepoSpec;
    'status'?: V1alpha1ExtensionRepoStatus;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "V1alpha1ExtensionRepoSpec"
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "V1alpha1ExtensionRepoStatus"
        }    ];

    static getAttributeTypeMap() {
        return V1alpha1ExtensionRepo.attributeTypeMap;
    }
}
