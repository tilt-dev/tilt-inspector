...
*/
export class V1alpha1Extension {
    /**
    ...
    */
    ...
    'spec'?: V1alpha1ExtensionSpec;
    'status'?: V1alpha1ExtensionStatus;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "V1alpha1ExtensionSpec"
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "V1alpha1ExtensionStatus"
        }    ];

    static getAttributeTypeMap() {
        return V1alpha1Extension.attributeTypeMap;
    }
}
